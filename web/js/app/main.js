...
require.config({
    ...
    paths: {
        //Angular SRC's
        'angular': '/js/node_modules/angular/angular',
        'ngAria': '/js/node_modules/angular-aria/angular-aria',
        'ngAnimate': '/js/node_modules/angular-animate/angular-animate',
        'ngMaterial': '/js/node_modules/angular-material/angular-material',
        //App Modules
